	...
	<div class="container">
		...
		<div class="row" style="background-color: #269ABC;height: 500px;">
					 <video id="example_video_1" class="video-js vjs-default-skin" autoplay="autoplay"
					      ...
					      data-setup="{}">
					    <source src="<%=res.getString("filegoldeurl")%>${musicCustom.mv }" type="video/mp4" />
					    <source src="<%=res.getString("filegoldeurl")%>${musicCustom.mv }" type='video/webm' />
					    <source src="<%=res.getString("filegoldeurl")%>${musicCustom.mv }" type='video/ogg' />
