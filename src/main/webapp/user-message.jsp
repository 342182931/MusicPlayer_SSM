	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-1" style="text-align: center;">
				<img src="<%=res.getString("filegoldeurl")%>${sessionScope.musicCustom.photo }" width="60px" height="60px"
		...
		<c:forEach items="${pageBean.listT }" var="messageCustom"
			...
			<div class="row">
				<div class="col-md-1">
					<img src="<%=res.getString("filegoldeurl")%>${messageCustom.user.photo }" class="img-circle"
