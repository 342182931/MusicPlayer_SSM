			...
			<div>
				...
				<div class="navbar-right" style="padding-right: 20px;">
					<ul class="nav navbar-nav">
						...
						<c:if test="${sessionScope.userCustom!=null }">
							<li><img src="<%=res.getString("filegoldeurl")%>${sessionScope.userCustom.photo }"
					...
					<form class="form-group" action="updateImg.action"
						...
						<div class="col-sm-4" style="text-align: center;">
							<input type="hidden" name="id"
								...
								src="<%=res.getString("filegoldeurl")%>${sessionScope.userCustom.photo }" id="imgsrc"
...
<script type="text/javascript">
	...
	var song = [ {
		...
		'src' : '<%=res.getString("filegoldeurl")%>/upload/mp3/王力宏、谭维维 - 缘分一道桥.mp3',
		'title' : '王力宏、谭维维 - 缘分一道桥'
	} ];
