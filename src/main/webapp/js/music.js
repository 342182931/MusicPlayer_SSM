				...
				success : function(data) {
					...
					for (var i = 0; i < musicjson.length; i++) {
						var tr = "<tr id='tr1'><td>"
								...
								+ "<div class=\"Btmusic\"><img src=\"img/play_1.png\" onclick=\"window.parent.getmusic('"
...
function getmusic(musichash) {
	$.ajax({
		type : "get",
		url : "https://www.kugou.com/yy/index.php?r=play/getdata&hash="+musichash,
		dataType : "jsonp",
		success : function(data) {
			if((data.status==0||data.err_code==20010)&&a<2){
				getmusic(musichash);
				a++;
				return;
			}
