...
<body>
	...
	<div class="col-md-9" style="padding-top: 20px;">
		...
		<c:forEach items="${pageBean_musicid.listT }" var="musicCustom"
				varStatus="status">
			<li onclick="play_music('${musicCustom.musicid}','${musicCustom.photo}','${musicCustom.path }','${musicCustom.name }')">
				<div class="img-thumbnail bianda">
					<img src="${musicCustom.photo}" class="img-responsive" width="150px"
			...
			<c:forEach items="${pageBean_songmenu.listT }" var="songmenuCustom"
				...
				<li><a
					href="findSongMenuByIdUser.action?songmenuid=${songmenuCustom.songmenuid }">
						<div class="img-thumbnail bianda">
							<img src="${songmenuCustom.photo }" class="img-responsive" width="150px"
	...
	<div class="col-md-3 listmusic" style="padding-top: 20px;">
		...
		<ul class="list-unstyled" id="rank_number_index">
			<c:forEach items="${pageBean_number.listT }" var="musicCustom"
				varStatus="status">
				<li onclick="play_music('${musicCustom.musicid}','${musicCustom.photo}','${musicCustom.path }','${musicCustom.name }')" style="padding-top:5px;">${status.count }.${musicCustom.name }</li>
			</c:forEach>
		</ul>
	</div>
