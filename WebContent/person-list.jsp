			...
			<table class="border-songmenu">
				<tr>
					<td rowspan="3"><img class="img-thumbnail"
						src="${sessionScope.personsongMenuCustom.photo }" height="150px"
						width="130"></td>
							...
							<td>${songlist.music.name }
								<div class="Btmusic">
									<img src="img/play_1.png"
										onclick="play_music('${songlist.music.musicid}','${songlist.music.photo}','${songlist.music.path }','${songlist.music.name }')" />
								</div>
							</td>
					...
					<form class="form-group" action="updateSongMenu.action"
						...
						<div class="col-sm-4" style="text-align: center;">
							<input type="hidden" name="userid"
								...
								src="${sessionScope.personsongMenuCustom.photo }" id="imgsrc"
